...
#define zLicenseDescrip (danetool_opt_strs+272)
 ...
 */
static char const danetool_opt_strs[2497] =
/*     0 */ "danetool 3.1.12\n"
            "Copyright (C) 2000-2012 Free Software Foundation, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
/*   272 */ "danetool is free software: you can redistribute it and/or modify it under\n"
...
/*   980 */ "OUTFILE\0"
/*   988 */ "outfile\0"
/*   996 */ "Loads a public key file\0"
/*  1020 */ "LOAD_PUBKEY\0"
/*  1032 */ "load-pubkey\0"
/*  1044 */ "Loads a certificate file\0"
/*  1069 */ "LOAD_CERTIFICATE\0"
/*  1086 */ "load-certificate\0"
/*  1103 */ "Sets a DLV file\0"
/*  1119 */ "DLV\0"
/*  1123 */ "dlv\0"
/*  1127 */ "Hash algorithm to use for signing.\0"
/*  1162 */ "HASH\0"
/*  1167 */ "hash\0"
/*  1172 */ "Check a host's DANE TLSA entry.\0"
/*  1204 */ "CHECK\0"
/*  1210 */ "check\0"
/*  1216 */ "Check only the end-entity's certificate.\0"
/*  1257 */ "CHECK_EE\0"
/*  1266 */ "check-ee\0"
/*  1275 */ "Check only the CA's certificate.\0"
/*  1308 */ "CHECK_CA\0"
/*  1317 */ "check-ca\0"
/*  1326 */ "Do not verify any DNSSEC signature.\0"
/*  1362 */ "INSECURE\0"
/*  1371 */ "insecure\0"
/*  1380 */ "Use the local DNS server for DNSSEC resolving.\0"
/*  1427 */ "LOCAL_DNS\0"
/*  1437 */ "no-local-dns\0"
/*  1450 */ "no\0"
/*  1453 */ "Use DER format for input certificates and private keys.\0"
/*  1509 */ "INDER\0"
/*  1515 */ "no-inder\0"
/*  1524 */ "an alias for the 'inder' option\0"
/*  1556 */ "inraw\0"
...
/*  1949 */ "X509\0"
/*  1954 */ "x509\0"
/*  1959 */ "an alias for the 'domain' option\0"
/*  1992 */ "local\0"
/*  1998 */ "The provided certificate or public key is issued by the local domain.\0"
/*  2068 */ "DOMAIN\0"
/*  2075 */ "no-domain\0"
/*  2085 */ "display extended usage information and exit\0"
/*  2129 */ "help\0"
/*  2134 */ "extended usage information passed thru pager\0"
/*  2179 */ "more-help\0"
/*  2189 */ "output version information and exit\0"
/*  2225 */ "version\0"
/*  2233 */ "DANETOOL\0"
/*  2242 */ "danetool - GnuTLS DANE tool\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  2328 */ "bug-gnutls@gnu.org\0"
/*  2347 */ "\n\0"
/*  2349 */ "Tool to generate and check DNS resource records for the DANE protocol.\n\0"
/*  2421 */ "danetool 3.1.12\0"
/*  2437 */ "danetool [options]\n"
...
#define DEBUG_DESC      (danetool_opt_strs+877)
/** Upper-cased name for the debug option */
#define DEBUG_NAME      (danetool_opt_strs+895)
/** Name string for the debug option */
#define DEBUG_name      (danetool_opt_strs+901)
...
#define VERBOSE_DESC      (danetool_opt_strs+907)
/** Upper-cased name for the verbose option */
#define VERBOSE_NAME      (danetool_opt_strs+927)
/** Name string for the verbose option */
#define VERBOSE_name      (danetool_opt_strs+935)
...
#define INFILE_DESC      (danetool_opt_strs+943)
/** Upper-cased name for the infile option */
#define INFILE_NAME      (danetool_opt_strs+954)
...
#define OUTFILE_DESC      (danetool_opt_strs+968)
/** Upper-cased name for the outfile option */
#define OUTFILE_NAME      (danetool_opt_strs+980)
/** Name string for the outfile option */
#define OUTFILE_name      (danetool_opt_strs+988)
...
#define LOAD_PUBKEY_DESC      (danetool_opt_strs+996)
/** Upper-cased name for the load-pubkey option */
#define LOAD_PUBKEY_NAME      (danetool_opt_strs+1020)
/** Name string for the load-pubkey option */
#define LOAD_PUBKEY_name      (danetool_opt_strs+1032)
...
#define LOAD_CERTIFICATE_DESC      (danetool_opt_strs+1044)
/** Upper-cased name for the load-certificate option */
#define LOAD_CERTIFICATE_NAME      (danetool_opt_strs+1069)
/** Name string for the load-certificate option */
#define LOAD_CERTIFICATE_name      (danetool_opt_strs+1086)
...
#define DLV_DESC      (danetool_opt_strs+1103)
/** Upper-cased name for the dlv option */
#define DLV_NAME      (danetool_opt_strs+1119)
...
#define HASH_DESC      (danetool_opt_strs+1127)
/** Upper-cased name for the hash option */
#define HASH_NAME      (danetool_opt_strs+1162)
/** Name string for the hash option */
#define HASH_name      (danetool_opt_strs+1167)
...
#define CHECK_DESC      (danetool_opt_strs+1172)
/** Upper-cased name for the check option */
#define CHECK_NAME      (danetool_opt_strs+1204)
/** Name string for the check option */
#define CHECK_name      (danetool_opt_strs+1210)
...
#define CHECK_EE_DESC      (danetool_opt_strs+1216)
/** Upper-cased name for the check-ee option */
#define CHECK_EE_NAME      (danetool_opt_strs+1257)
/** Name string for the check-ee option */
#define CHECK_EE_name      (danetool_opt_strs+1266)
...
#define CHECK_CA_DESC      (danetool_opt_strs+1275)
/** Upper-cased name for the check-ca option */
#define CHECK_CA_NAME      (danetool_opt_strs+1308)
/** Name string for the check-ca option */
#define CHECK_CA_name      (danetool_opt_strs+1317)
...
#define INSECURE_DESC      (danetool_opt_strs+1326)
/** Upper-cased name for the insecure option */
#define INSECURE_NAME      (danetool_opt_strs+1362)
/** Name string for the insecure option */
#define INSECURE_name      (danetool_opt_strs+1371)
...
#define LOCAL_DNS_DESC      (danetool_opt_strs+1380)
/** Upper-cased name for the local-dns option */
#define LOCAL_DNS_NAME      (danetool_opt_strs+1427)
/** disablement name for the local-dns option */
#define NOT_LOCAL_DNS_name  (danetool_opt_strs+1437)
/** disablement prefix for the local-dns option */
#define NOT_LOCAL_DNS_PFX   (danetool_opt_strs+1450)
...
#define INDER_DESC      (danetool_opt_strs+1453)
/** Upper-cased name for the inder option */
#define INDER_NAME      (danetool_opt_strs+1509)
/** disablement name for the inder option */
#define NOT_INDER_name  (danetool_opt_strs+1515)
/** disablement prefix for the inder option */
#define NOT_INDER_PFX   (danetool_opt_strs+1450)
...
#define INRAW_DESC    (danetool_opt_strs+1524)
...
#define LOCAL_name    (danetool_opt_strs+1992)
...
#define DOMAIN_DESC      (danetool_opt_strs+1998)
/** Upper-cased name for the domain option */
#define DOMAIN_NAME      (danetool_opt_strs+2068)
/** disablement name for the domain option */
#define NOT_DOMAIN_name  (danetool_opt_strs+2075)
/** disablement prefix for the domain option */
#define NOT_DOMAIN_PFX   (danetool_opt_strs+1450)
 ...
 */
#define HELP_DESC       (danetool_opt_strs+2085)
#define HELP_name       (danetool_opt_strs+2129)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (danetool_opt_strs+2134)
#define MORE_HELP_name  (danetool_opt_strs+2179)
...
#endif
#define VER_DESC        (danetool_opt_strs+2189)
#define VER_name        (danetool_opt_strs+2225)
/**
...
#define zPROGNAME       (danetool_opt_strs+2233)
/** Reference to the title line for danetool usage. */
#define zUsageTitle     (danetool_opt_strs+2242)
...
#define zBugsAddr       (danetool_opt_strs+2328)
/** Clarification/explanation of what danetool does. */
#define zExplain        (danetool_opt_strs+2347)
/** Extra detail explaining what danetool does. */
#define zDetail         (danetool_opt_strs+2349)
/** The full version string for danetool. */
#define zFullVersion    (danetool_opt_strs+2421)
...
#define danetool_short_usage (danetool_opt_strs+2437)
