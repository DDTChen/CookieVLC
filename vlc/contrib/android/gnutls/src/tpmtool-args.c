 ...
 *
 *  It has been AutoGen-ed  June  1, 2013 at 01:07:32 PM by AutoGen 5.17.3
...
#define zLicenseDescrip (tpmtool_opt_strs+271)
 ...
 */
static char const tpmtool_opt_strs[2097] =
/*     0 */ "tpmtool 3.1.12\n"
            "Copyright (C) 2000-2012 Free Software Foundation, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
/*   271 */ "tpmtool is free software: you can redistribute it and/or modify it under\n"
...
/*   941 */ "OUTFILE\0"
/*   949 */ "outfile\0"
/*   957 */ "Generate an RSA private-public key pair\0"
/*   997 */ "GENERATE_RSA\0"
/*  1010 */ "generate-rsa\0"
/*  1023 */ "Any generated key will be registered in the TPM\0"
/*  1071 */ "REGISTER\0"
/*  1080 */ "register\0"
/*  1089 */ "Any generated key will be a signing key\0"
/*  1129 */ "SIGNING\0"
/*  1137 */ "signing\0"
/*  1145 */ "Any generated key will be a legacy key\0"
/*  1184 */ "LEGACY\0"
/*  1191 */ "legacy\0"
/*  1198 */ "Any registered key will be a user key\0"
/*  1236 */ "USER\0"
/*  1241 */ "user\0"
/*  1246 */ "Any registred key will be a system key\0"
/*  1285 */ "SYSTEM\0"
/*  1292 */ "system\0"
/*  1299 */ "Prints the public key of the provided key\0"
/*  1341 */ "PUBKEY\0"
/*  1348 */ "pubkey\0"
/*  1355 */ "Lists all stored keys in the TPM\0"
/*  1388 */ "LIST\0"
/*  1393 */ "list\0"
/*  1398 */ "Delete the key identified by the given URL (UUID).\0"
/*  1449 */ "DELETE\0"
/*  1456 */ "delete\0"
/*  1463 */ "Specify the security level [low, legacy, normal, high, ultra].\0"
/*  1526 */ "SEC_PARAM\0"
/*  1536 */ "sec-param\0"
/*  1546 */ "Specify the number of bits for key generate\0"
/*  1590 */ "BITS\0"
/*  1595 */ "bits\0"
/*  1600 */ "Use the DER format for keys.\0"
/*  1629 */ "INDER\0"
/*  1635 */ "no-inder\0"
/*  1644 */ "no\0"
/*  1647 */ "Use DER format for output keys\0"
/*  1678 */ "OUTDER\0"
/*  1685 */ "no-outder\0"
/*  1695 */ "display extended usage information and exit\0"
/*  1739 */ "help\0"
/*  1744 */ "extended usage information passed thru pager\0"
/*  1789 */ "more-help\0"
/*  1799 */ "output version information and exit\0"
/*  1835 */ "version\0"
/*  1843 */ "TPMTOOL\0"
/*  1851 */ "tpmtool - GnuTLS TPM tool\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  1935 */ "bug-gnutls@gnu.org\0"
/*  1954 */ "\n\0"
/*  1956 */ "Program that allows handling cryptographic data from the TPM chip.\n\0"
/*  2024 */ "tpmtool 3.1.12\0"
/*  2039 */ "tpmtool [options]\n"
...
#define DEBUG_DESC      (tpmtool_opt_strs+874)
/** Upper-cased name for the debug option */
#define DEBUG_NAME      (tpmtool_opt_strs+892)
/** Name string for the debug option */
#define DEBUG_name      (tpmtool_opt_strs+898)
...
#define INFILE_DESC      (tpmtool_opt_strs+904)
/** Upper-cased name for the infile option */
#define INFILE_NAME      (tpmtool_opt_strs+915)
...
#define OUTFILE_DESC      (tpmtool_opt_strs+929)
/** Upper-cased name for the outfile option */
#define OUTFILE_NAME      (tpmtool_opt_strs+941)
/** Name string for the outfile option */
#define OUTFILE_name      (tpmtool_opt_strs+949)
...
#define GENERATE_RSA_DESC      (tpmtool_opt_strs+957)
/** Upper-cased name for the generate-rsa option */
#define GENERATE_RSA_NAME      (tpmtool_opt_strs+997)
/** Name string for the generate-rsa option */
#define GENERATE_RSA_name      (tpmtool_opt_strs+1010)
...
#define REGISTER_DESC      (tpmtool_opt_strs+1023)
/** Upper-cased name for the register option */
#define REGISTER_NAME      (tpmtool_opt_strs+1071)
/** Name string for the register option */
#define REGISTER_name      (tpmtool_opt_strs+1080)
...
#define SIGNING_DESC      (tpmtool_opt_strs+1089)
/** Upper-cased name for the signing option */
#define SIGNING_NAME      (tpmtool_opt_strs+1129)
/** Name string for the signing option */
#define SIGNING_name      (tpmtool_opt_strs+1137)
...
#define LEGACY_DESC      (tpmtool_opt_strs+1145)
/** Upper-cased name for the legacy option */
#define LEGACY_NAME      (tpmtool_opt_strs+1184)
...
#define USER_DESC      (tpmtool_opt_strs+1198)
/** Upper-cased name for the user option */
#define USER_NAME      (tpmtool_opt_strs+1236)
/** Name string for the user option */
#define USER_name      (tpmtool_opt_strs+1241)
...
#define SYSTEM_DESC      (tpmtool_opt_strs+1246)
/** Upper-cased name for the system option */
#define SYSTEM_NAME      (tpmtool_opt_strs+1285)
...
#define PUBKEY_DESC      (tpmtool_opt_strs+1299)
/** Upper-cased name for the pubkey option */
#define PUBKEY_NAME      (tpmtool_opt_strs+1341)
...
#define LIST_DESC      (tpmtool_opt_strs+1355)
/** Upper-cased name for the list option */
#define LIST_NAME      (tpmtool_opt_strs+1388)
/** Name string for the list option */
#define LIST_name      (tpmtool_opt_strs+1393)
...
#define DELETE_DESC      (tpmtool_opt_strs+1398)
/** Upper-cased name for the delete option */
#define DELETE_NAME      (tpmtool_opt_strs+1449)
...
#define SEC_PARAM_DESC      (tpmtool_opt_strs+1463)
/** Upper-cased name for the sec-param option */
#define SEC_PARAM_NAME      (tpmtool_opt_strs+1526)
...
#define BITS_DESC      (tpmtool_opt_strs+1546)
/** Upper-cased name for the bits option */
#define BITS_NAME      (tpmtool_opt_strs+1590)
/** Name string for the bits option */
#define BITS_name      (tpmtool_opt_strs+1595)
...
#define INDER_DESC      (tpmtool_opt_strs+1600)
/** Upper-cased name for the inder option */
#define INDER_NAME      (tpmtool_opt_strs+1629)
/** disablement name for the inder option */
#define NOT_INDER_name  (tpmtool_opt_strs+1635)
/** disablement prefix for the inder option */
#define NOT_INDER_PFX   (tpmtool_opt_strs+1644)
...
#define OUTDER_DESC      (tpmtool_opt_strs+1647)
/** Upper-cased name for the outder option */
#define OUTDER_NAME      (tpmtool_opt_strs+1678)
/** disablement name for the outder option */
#define NOT_OUTDER_name  (tpmtool_opt_strs+1685)
/** disablement prefix for the outder option */
#define NOT_OUTDER_PFX   (tpmtool_opt_strs+1644)
 ...
 */
#define HELP_DESC       (tpmtool_opt_strs+1695)
#define HELP_name       (tpmtool_opt_strs+1739)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (tpmtool_opt_strs+1744)
#define MORE_HELP_name  (tpmtool_opt_strs+1789)
...
#endif
#define VER_DESC        (tpmtool_opt_strs+1799)
#define VER_name        (tpmtool_opt_strs+1835)
/**
...
#define zPROGNAME       (tpmtool_opt_strs+1843)
/** Reference to the title line for tpmtool usage. */
#define zUsageTitle     (tpmtool_opt_strs+1851)
...
#define zBugsAddr       (tpmtool_opt_strs+1935)
/** Clarification/explanation of what tpmtool does. */
#define zExplain        (tpmtool_opt_strs+1954)
/** Extra detail explaining what tpmtool does. */
#define zDetail         (tpmtool_opt_strs+1956)
/** The full version string for tpmtool. */
#define zFullVersion    (tpmtool_opt_strs+2024)
...
#define tpmtool_short_usage (tpmtool_opt_strs+2039)
